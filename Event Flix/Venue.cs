...
namespace Event_Flix
{
    public partial class Venue : Form
    {
        ...
        SqlConnection ConV = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\DELL\Desktop\2nd sem project\Event Flix\Event Flix\Event MS.mdf"";Integrated Security=True;Connect Timeout=30");
